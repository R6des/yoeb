...
SetGoodsCaoZuo(nil,"0","点金石","Metadata/Items/Currency/CurrencyUpgradeToRare",nil,nil,nil,nil)
...
SetGoodsCaoZuo("爪|符文匕首|单手剑|细剑|单手斧|单手锤","0|1",nil,nil,nil,nil,nil,nil,"2")--捡卖黄武
SetGoodsCaoZuo("珠宝|深渊珠宝|法杖|匕首|符文匕首|短杖|战杖|弓|长杖|双手剑|双手斧|双手锤","0|1|4",nil,nil,nil,nil,nil,nil,"2")--拾取 鉴定 出售黄色物品珠宝
...
SetGoodsCaoZuo(nil,"0|2","束縛石","Metadata/Items/Currency/CurrencyUpgradeToRareAndSetSockets",nil,nil,nil,nil)--束縛石
