...
SetNeedBuyGoodsData("重铸石","Metadata/Items/Currency/CurrencyConvertToNormal",100,"后悔石","Metadata/Items/Currency/CurrencyPassiveRefund")
SetNeedBuyGoodsData("后悔石","Metadata/Items/Currency/CurrencyPassiveRefund",100,"点金石","Metadata/Items/Currency/CurrencyUpgradeToRare")
...
SetGoodsCaoZuo("命运卡","0|1")--拾取 出售命运卡
