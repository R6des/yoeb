...
SetNeedSkillLineData(100,"靈體旋武,nil|夜刃輔助,nil|物理轉閃電輔助,nil|三體輔助,nil|附加冰冷傷害輔助,nil|霜咬輔助,nil|元素攻擊傷害輔助,nil|啟發輔助,nil|快速攻擊輔助,nil",nil,nil,nil)
...
SetAtuoChangeEquipData("游侠","匕首","Local_Maximum_Added_Fire_Damage",1,nil)
SetAtuoChangeEquipData("游侠","匕首","Local_Maximum_Added_cold_Damage",1,nil)
SetAtuoChangeEquipData("游侠","匕首","Local_Maximum_Added_lightning_Damage",1,nil)
SetAtuoChangeEquipData("游侠","匕首","Local_critical_strike_chance_%",3,nil)
SetAtuoChangeEquipData("游侠","盾","护甲",0.1,nil)

--游侠--孔色
SetZhengTiColorVarData(2,2,2,2,nil,600,true)
SetZhengTiColorVarData(2,1,2,2,nil,550,true)
SetZhengTiColorVarData(2,0,3,2,nil,500,true)
SetZhengTiColorVarData(2,0,2,2,nil,450,true)
SetZhengTiColorVarData(2,0,4,0,nil,400,true)
SetZhengTiColorVarData(2,0,3,1,nil,350,true)
SetZhengTiColorVarData(2,1,3,0,nil,330,true)
