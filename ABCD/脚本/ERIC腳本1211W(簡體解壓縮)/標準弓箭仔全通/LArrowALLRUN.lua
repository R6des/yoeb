...
SetNeedSkillLineData(96,"魔改箭矢輔助,nil|箭雨,nil|冰霜射擊,nil",nil,10,1,nil,nil,nil,nil,nil,nil,nil,nil,true,nil)
SetNeedSkillLineData(97,"元素淨化,nil|啟蒙輔助,nil|憤怒,nil",nil,9,1,nil,nil,nil,nil,nil,nil,nil,nil,nil,nil)
SetNeedSkillLineData(98,"擊中時印記輔助,nil|狙擊者印記,nil|狂戰,nil|鋼筋鐵骨,nil",nil,5,1,nil,nil,nil,nil,nil,nil,nil,nil,true,nil)
SetNeedSkillLineData(99,"魔改箭矢輔助,nil|狂怒,nil|暴擊獲得暴擊球輔助,nil|龍捲射擊,nil|誘捕箭矢,nil|元素打擊,nil",nil,3,1,nil,nil,nil,nil,nil,nil,nil,nil,true,nil)
SetNeedSkillLineData(100,"閃電箭矢,nil,1|附加冰冷傷害輔助,nil|元素攻擊傷害輔助,nil|三體輔助,nil|啟發輔助,nil|幻影射手輔助,nil",nil,2,1,nil,nil,nil,nil,nil,nil,nil,nil,true,nil)
...
SetGaoJiHuanZhuangData("游侠","生皮短靴","Metadata/Items/Armours/Boots/BootsDex1","盟誓之跡","Seven-League Step",nil,nil,nil,nil,nil,nil,nil,nil,nil,nil,nil,nil,nil,nil,nil)
