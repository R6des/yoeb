...
SetNeedSkillLineData(93,"閃電箭矢,nil|附加冰冷傷害輔助,nil|元素攻擊傷害輔助,nil|三體輔助,nil|啟發輔助,nil|幻影射手輔助,nil",nil,nil,nil)
SetNeedSkillLineData(94,"火砲砲塔,nil|元素攻擊傷害輔助,nil|快速攻擊輔助,nil|多重圖騰輔助,nil",nil,nil,nil)
SetNeedSkillLineData(95,"鋼筋鐵骨,nil|元素淨化,nil|憤怒,nil",nil,nil,nil)
SetNeedSkillLineData(96,"擊中時印記輔助,nil|狙擊者印記,nil|幻步,nil",nil,nil,nil)
...
SetNeedSkillLineData(99,"電流箭矢,nil|附加冰冷傷害輔助,nil|元素攻擊傷害輔助,nil|幻影射手輔助,nil",40,nil,nil)
