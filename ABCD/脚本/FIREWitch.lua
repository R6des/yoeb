...
SetUseWeapon("法杖|盾")
--设置自己用的装备类型 
SetUseZhuangBeiTypeData("Int","衣服")
...
SetNeedSkillLineData(89,"淨化烈焰,nil|召喚幻影輔助,nil|召喚物傷害輔助,nil",8,nil,0)--2衣服
...
SetNeedSkillLineData(90,"召喚憤怒狂靈,nil|煉獄軍團輔助,nil|施放迴響輔助,nil|召喚物生命輔助,nil|召喚物傷害輔助,nil|元素集中輔助,nil|集中效應輔助,nil",nil,nil,0)


--添加攻击技能 name=技能名 className=技能类名 noLine=不在直线就能攻击 挑选攻击技能会从上到下寻找，要把厉害的技能加在前面
AddAttackSkillData("召喚憤怒狂靈","Summon Raging Spirit")
...
SetZhengTiColorVarData(2,0,0,6,nil,600,true)--red green blue
SetZhengTiColorVarData(2,0,0,5,nil,500,true)
SetZhengTiColorVarData(2,0,0,4,nil,400,true)
SetZhengTiColorVarData(2,0,0,3,nil,300,true)
SetZhengTiColorVarData(2,0,0,2,nil,200,true)
SetZhengTiColorVarData(2,0,0,1,nil,100)
